    ...
    public SDServer() throws IOException {
        ...
        server.addListener(new Listener() {
            ...
            public void disconnected (Connection c) {
                try {
                    ch.print(players.get(getMPlayer(c.getID())).getName() + " Disconnected");
                    broadcast(players.get(getMPlayer(c.getID())).getName() + " has disconnected.", serverPrefix);
